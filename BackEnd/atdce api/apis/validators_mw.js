...
const BlogValidation = [
    body('blog_title').notEmpty().withMessage('Blog title cannot be empty!'),
...
const CandValidation = [
    body('cand_name').notEmpty().withMessage("Candidate's name cannot be empty"),
    body('cand_email').isEmail().withMessage("Invalid email format")
];

const EventValidation = [
    body('event_title').notEmpty().withMessage('Event title cannot be empty!'),
    body('date').notEmpty().withMessage('Date field cannot be empty!'),
    body('date').isISO8601().withMessage('Invalid date format')
];

const CandAppValidation = [
    body('cand_name').notEmpty().withMessage("Candidate's name cannot be empty!"),
    body('cand_email').isEmail().withMessage('Invalid email format'),
    body('resume_path').notEmpty().withMessage('Resume path is required')
];
...
const NewsValidation = [
    body('news_title').notEmpty().withMessage('News title cannot be empty'),
...
const PartValidation = [
    body('part_name').notEmpty().withMessage("Partner's name cannot be empty"),
...
const ProjectValidation = [
    body('project_name').notEmpty().withMessage('Project title cannot be empty!'),
    body('description').notEmpty().withMessage('Description field cannot be empty!'),
    body('project_url').notEmpty().withMessage('An image URL is required!')
];

const VolValidation = [
    body('vol_name').notEmpty().withMessage("Volunteer's name cannot be empty"),
...
const LocationValidation = [
    body('location_name').notEmpty().withMessage('Location name cannot be empty')
];

const createFundValidation = [
    body('amount').notEmpty().withMessage('Amount is required').isNumeric().withMessage('Amount must be only numeric'),
    body('description').notEmpty().withMessage('Description field cannot be empty!'),
...
const VolAppValidation = [
    body('vol_name').notEmpty().withMessage('Volunteer name is required'),
